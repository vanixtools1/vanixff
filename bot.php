...
if(!file_exists('config.json')){
	$token = readline('Hi SARA Enter Token: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/qqqqqqqpqpqq/3",
                   'caption'=>'𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @E77710 💙',
          	...
          	if($config['mode'] != null){
          		$mode = $config['mode'];
          		if($mode == 'addL'){
          			$ig = new ig(['file'=>'','account'=>['useragent'=>'Instagram 84.0.522.52 Android (23/6.0.1; 640dpi; 1440x2392; LGE/lge; RS988; h1; h1; en_US)']]);
          			...
          			if(isset($body->message)){
          				...
          				$account = ['cookies'=>$CookieStr,'useragent'=>'Instagram 84.0.522.52 Android (23/6.0.1; 640dpi; 1440x2392; LGE/lge; RS988; h1; h1; en_US)'];
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 SARA 』','url'=>'t.me/E77710']],
                          [['text'=>"▪️| اشترك قناه المطوره", 'url'=>"https://t.me/E77711"]],
                      ]
                  ])
              ]);   
				}
